...
**Effect:** Green Matrix code waterfall with "Wake up, Neo..."
**Duration:** 4 seconds

## 2. ⚡ Power Up (Dragon Ball Z)
**How:** Tap "Add" on the "Power Up" workout in the exercise list
**Effect:** "IT'S OVER 9000!" with golden aura and power level display
**Duration:** 3.5 seconds

## 3. 🎩 Press it for Glory! (HIMYM - Barney)
**How:** Long-press (hold 1.5 seconds) your profile avatar in top right
**Effect:** "Press it..." → "Press it for GLORY!" with gold confetti
**Duration:** 5 seconds
